...
<div class="max-w-2xl mx-auto">
        <div class="bg-white rounded-lg shadow-md p-6">
            <h1 class="text-2xl font-bold text-[#2E5A43] mb-6">Tambah Menu Baru</h1>
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <textarea name="deskripsi" rows="3" required
                                  class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-[#2E5A43] focus:ring focus:ring-[#2E5A43] focus:ring-opacity-50">{{ old('deskripsi') }}</textarea>
                        @error('deskripsi')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div class="flex items-center">
                        <input type="checkbox" name="tersedia" id="tersedia" value="1" {{ old('tersedia') ? 'checked' : '' }}
